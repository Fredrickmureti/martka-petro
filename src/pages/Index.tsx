      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="border border-border bg-card text-card-foreground shadow-xl hover:shadow-2xl transition-shadow duration-300">
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold mt-4 text-foreground">{servicesContent.title || "Comprehensive Petroleum Solutions"}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="bg-card border border-border text-card-foreground shadow-xl hover:shadow-2xl transition-shadow duration-300">
              <CardHeader>
                <CardTitle className="text-xl font-semibold text-foreground">{servicesContent.service1Title || "Equipment Installation"}</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-card border border-border text-card-foreground shadow-xl hover:shadow-2xl transition-shadow duration-300">
              <CardHeader>
                <CardTitle className="text-xl font-semibold text-foreground">{servicesContent.service2Title || "Maintenance & Support"}</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-card border border-border text-card-foreground shadow-xl hover:shadow-2xl transition-shadow duration-300">
              <CardHeader>
                <CardTitle className="text-xl font-semibold text-foreground">{servicesContent.service3Title || "Consulting Services"}</CardTitle>
              </CardHeader>
              <CardContent>
