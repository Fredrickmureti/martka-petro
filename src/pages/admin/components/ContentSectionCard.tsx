  ...
  return (
    <div className="grid md:grid-cols-2 gap-6">
        ...
        <CardContent>
          {isEditing ? (
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-medium text-sm text-muted-foreground mb-2">Current Content (JSON):</h4>
                <div className="bg-slate-50 dark:bg-slate-900 rounded-md p-3 text-sm max-h-40 overflow-y-auto">
      ...
      <div className="space-y-2">
        <h4 className="font-medium text-sm text-muted-foreground">Live Preview (How it appears on website):</h4>
        <ContentPreview
